...
.. "auto_examples/plot_cavity_flow.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_cavity_flow.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_cavity_flow.py:
...
.. _sphx_glr_download_auto_examples_plot_cavity_flow.py:
